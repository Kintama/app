...
<body>
	<header>
		<div class="inner">  
			...
			<form action="${rootURL}insertCable.jsp" method="get">
	 			<button style="float: right;">Neues Kabel</button>
			</form>
			<form action="${rootURL}delete.jsp" method="get">
				<button style="float: right;">Lösche Kabel</button>
			</form>
		</div>
	</header>
	<div>
		<c:out value="${res.id}"></c:out>
			...
			<c:otherwise>
			<article>
				<form:form method="post" action="main" modelAttribute="location">
					<form:input path="name" />
					<input type="submit" value="Suche nach Ort" />
				</form:form>
